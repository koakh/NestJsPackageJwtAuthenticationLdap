...
exports.ConsumerAppService = void 0;
const common_1 = require("@nestjs/common");
const utils_1 = require("../utils");
let ConsumerAppService = (() => {
  let _classDecorators = [(0, common_1.Injectable)()];
  let _classDescriptor;
  let _classExtraInitializers = [];
  let _classThis;
  var ConsumerAppService = _classThis = class {
    constructor() {
    ...
    initRenewTokenSecrets() {
      this.jwtSecrets = {
        accessTokenJwtSecret: (0, utils_1.randomSecret)(),
        refreshTokenJwtSecret: (0, utils_1.randomSecret)(),
      };
