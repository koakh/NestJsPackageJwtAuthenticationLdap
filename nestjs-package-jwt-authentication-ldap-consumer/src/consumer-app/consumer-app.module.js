...
exports.ConsumerAppModule = void 0;
const common_1 = require("@nestjs/common");
const consumer_app_service_1 = require("./consumer-app.service");
let ConsumerAppModule = (() => {
    let _classDecorators = [(0, common_1.Module)({
            providers: [consumer_app_service_1.ConsumerAppService],
            ...
            //   })  
            exports: [consumer_app_service_1.ConsumerAppService],
        })];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    var ConsumerAppModule = _classThis = class {
    };
    __setFunctionName(_classThis, "ConsumerAppModule");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        ConsumerAppModule = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return ConsumerAppModule = _classThis;
})();
exports.ConsumerAppModule = ConsumerAppModule;
